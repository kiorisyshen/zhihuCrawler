...
def get_list():
    url1 = 'https://zhuanlan.zhihu.com/api2/columns/c_119702958/articles?include=data%5B*%5D.admin_closed_comment%2Ccomment_count%2Csuggest_edit%2Cis_title_image_full_screen%2Ccan_comment%2Cupvoted_followees%2Ccan_open_tipjar%2Ccan_tip%2Cvoteup_count%2Cvoting%2Ctopics%2Creview_info%2Cauthor.is_following%2Cis_labeled%2Clabel_info&limit=100&offset=0'
    url2 = 'https://zhuanlan.zhihu.com/api2/columns/c_119702958/articles?include=data%5B*%5D.admin_closed_comment%2Ccomment_count%2Csuggest_edit%2Cis_title_image_full_screen%2Ccan_comment%2Cupvoted_followees%2Ccan_open_tipjar%2Ccan_tip%2Cvoteup_count%2Cvoting%2Ctopics%2Creview_info%2Cauthor.is_following%2Cis_labeled%2Clabel_info&limit=38&offset=100'
    urls = [url1, url2]
    print(urls)
    article_dict = {}
    for url in urls:
...
def to_pdf():
    ...
    pdfkit.from_file(sorted(htmls), author + '.pdf', options=options)

if __name__ == '__main__':
    author = input('Please input author name:(default c_119702958)')
    if not author:
        author = 'c_119702958'
    headers = {
